...
installation2ocean <- data.frame(Installation = c("Regional01", "Regional02", "Regional03", "Regional04", "Regional05", "Regional06", "Regional07", "Regional08", "Regional09", "Regional10", "Regional11"),
                                Region = c(rep("Nordsjøen",4), rep("Norskehavet",4), rep("Barentshavet",3)))
...
skagerrak <- read_xlsx("../../01_Data/01_Indeksverdier/03_Blotbunn_hav_MODdatabasen2023/Skagerrak_stations_2021_2023.xlsx")
print(paste0("Størrelse datasett Skagerrak 2021-2023: ",dim(skagerrak)[1]))

# Beregner gjennomsnitt og kombinerer med data for andre områder
skagerrak <- skagerrak %>% 
